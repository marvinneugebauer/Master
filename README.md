...
<br/>
<br/>
The second dataset we are utilizing is **Lost and Found** dataset. Unlike the Cityscapes dataset the Lost and Found dataset has its focus on enabling semantic segmentation algorithms detecting small obstacles on the road, which can be potentially seen as hazardous. The Cityscapes dataset can be found here:
